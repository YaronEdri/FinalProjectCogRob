...
def spawn_model_at_random_location():
    ...
    locations = [
        (24.8, 27.47, 0.1, 0.0, 0.0, 0.0),
        (2.82, 26.8, 0.1, 0.0, 0.0, 0.0),
        (3.32, 41.94, 0.1, 0.0, 0.0, 0.0),
        (24.7, -0.9389, 0.1, 0.0, 0.0, 0.0),
        (-2.22, 23.71, 0.1, 0.0, 0.0, 0.0),
        (11.26, 23.53, 0.1, 0.0, 0.0, 0.0),
        (10.87, 43.94, 0.1, 0.0, 0.0, 0.0),
        (-1.86, 47.11, 0.1, 0.0, 0.0, 0.0),
        (-3.8, 5.15, 0.1, 0.0, 0.0, 0.0),
        (30.86, 20.27, 0.1, 0.0, 0.0, 0.0)
